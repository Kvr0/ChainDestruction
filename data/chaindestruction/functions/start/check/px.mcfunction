#> chaindestruction:start/check/px
...
## 座標カウンタ
    scoreboard players add $chaindestruction:start/_.count.x temporary 1
...
## 次点
    ...
    execute if score $chaindestruction:start/_.count.y temporary > $chaindestruction:start/_.mincount temporary unless score $chaindestruction:start/check/dig.result temporary matches 1 unless data storage calculation: input.tool.tag{ChainDestruction:{IgnoreUnder:1b}} if score $chaindestruction:start/_.count temporary < $chaindestruction:start/_.max temporary positioned ~ ~-1 ~ run function chaindestruction:start/check/my
...
## 座標カウンタ
    scoreboard players remove $chaindestruction:start/_.count.x temporary 1
