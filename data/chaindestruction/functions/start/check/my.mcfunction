#> chaindestruction:start/check/my
...
## 座標カウンタ
    scoreboard players remove $chaindestruction:start/_.count.y temporary 1
...
## 座標カウンタ
    scoreboard players add $chaindestruction:start/_.count.y temporary 1
