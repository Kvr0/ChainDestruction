...
## 次点
    ...
    #execute if score $chaindestruction:start/_.count.y temporary > $chaindestruction:start/_.mincount temporary unless score $chaindestruction:start/check/dig.result temporary matches 1 unless data storage calculation: input.tool.tag{IgnoreUnder:1b} if score $chaindestruction:start/_.count temporary < $chaindestruction:start/_.max temporary positioned ~ ~-1 ~ run function chaindestruction:start/check/my
